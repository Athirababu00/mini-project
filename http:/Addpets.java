...
public class AddPets extends Fragment {
    String CATGNAME, PETNAME, PETAGE, PETDESC, PETRATE,PROLAT, PROLONG;
    EditText pet, petage, petdesc, petrate;
    Button addproduct;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View root = inflater.inflate(R.layout.add_pet, container, false);


        pet =(EditText)root.findViewById(R.id.pet_name);
        petage =(EditText)root.findViewById(R.id.pet_age);
        petdesc =(EditText)root.findViewById(R.id.property_desc);
        petrate =(EditText)root.findViewById(R.id.property_rate);
        ...
        addproduct.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PETNAME = pet.getText().toString().trim();
                PETAGE = petage.getText().toString().trim();
                PETDESC = petdesc.getText().toString().trim();
                PETRATE = petrate.getText().toString().trim();

                if (PETNAME.isEmpty()) {
                    pet.requestFocus();
                    pet.setError("Enter Breed Name");
                }else if (PETAGE.isEmpty()) {
                    petage.requestFocus();
                    petage.setError("Enter Pet Age");
                }else if (PETDESC.isEmpty()) {
                    petdesc.requestFocus();
                    petdesc.setError("Enter Description");
                }else  if (PETRATE.isEmpty()) {
                    petrate.requestFocus();
                    petrate.setError("Enter the Rate");
    ...
    public void addPet() {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, Utility.SERVERUrl, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                {
                    Toast.makeText(getContext(), "Pet Added Successful", Toast.LENGTH_LONG).show();
                    AddPets fragment = new AddPets();
                ...
                {
                    Toast.makeText(getContext(), "Error in Adding Pet", Toast.LENGTH_LONG).show();
                }
            }
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                map.put("key","addPet");
                map.put("uid",uid);
                map.put("p_name", PETNAME);
                map.put("p_age", PETAGE);
                map.put("p_desc", PETDESC);
                map.put("p_price", PETRATE);
