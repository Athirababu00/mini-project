...
import com.syntax.petvet.ADMIN.Admin;
import com.syntax.petvet.CENTERS.Center;
import com.syntax.petvet.DOGWALKER.DogWalker;
import com.syntax.petvet.PETSHOP.PetShop;
import com.syntax.petvet.USER.User;
        ...
        StringRequest request = new StringRequest(Request.Method.POST, Utility.SERVERUrl, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if (!response.trim().equals("failed")) {
                    ...
                    } else if (respArr[1].trim().equals("Veterinary")) {
                        startActivity(new Intent(getApplicationContext(), Center.class));
                        Toast.makeText(getApplicationContext(), "Login Successful", Toast.LENGTH_SHORT).show();
                    } else if (respArr[1].trim().equals("PetShops")) {
                        startActivity(new Intent(getApplicationContext(), PetShop.class));
                        Toast.makeText(getApplicationContext(), "Login Successful", Toast.LENGTH_SHORT).show();
                    } else if (respArr[1].trim().equals("DOGWALKER")) {
                        startActivity(new Intent(getApplicationContext(), DogWalker.class));
                        Toast.makeText(getApplicationContext(), "Login Successful", Toast.LENGTH_SHORT).show();
