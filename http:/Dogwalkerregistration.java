package com.syntax.petvet.DOGWALKER;
...
import com.syntax.petvet.LoginActivity;
import com.syntax.petvet.R;
import com.syntax.petvet.RegistrationActivity;
...
public class DogWalkerRegistration extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dogwalker_registration);
...
//        System.out.println("Current Date: " + ft.format(dNow));
        ...
        register=findViewById(R.id.dogwaller_registerButton);
...
//                SharedPreferences sp=getSharedPreferences("booking_info", Context.MODE_PRIVATE);
                map.put("key", "dogwalker_register");
